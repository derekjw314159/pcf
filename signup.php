	...
	else
	{
		...
		{			
			...
			$message = "					
						Hello $uname,
						<br /><br />
						Welcome to the County Parental Consent Register<br/>
						To complete your registration  please , just click following link<br/>
						<br /><br />
						<a href='http://localhost/pcf/verify.php?id=$id&code=$code'>Click HERE to Activate :)</a>
						<br /><br />
						Thank you,";
						
			$subject = "Confirm Registration to County Parental Consent Registration";
...
<html>
  <head>
    <title>Signup | Parental Consent System</title>
    <!-- Bootstrap -->
